      ...
      return {
        ...
        intervals: [
          ...
          },
          {
            ...
            value: T(
              spec?.tire.replacementKm ?? "40,000–50,000 km",
              spec?.tire.replacementKm ?? "40 000–50 000 км",
              spec?.tire.replacementKm ?? "40,000–50,000 km",
            ),
            tone: "accent",
          },
        ...
        inspection: TL(
          [
            "Bosimni oyiga 1 marta va uzoq safardan oldin tekshiring.",
            "Shina holatini har 10 000 km da ko'zdan kechiring.",
            "Balanslash — har 10 000–15 000 km.",
            "Tekislash — har 20 000 km yoki rul o'zgarsa.",
            "Bosimni doim sovuq shinada o'lchang.",
          ],
          [
            "Проверяйте давление раз в месяц и перед дальней поездкой.",
            "Осматривайте шины каждые 10 000 км.",
            "Балансировка — каждые 10 000–15 000 км.",
            "Развал-схождение — каждые 20 000 км или при уводе руля.",
            "Меряйте давление на холодных шинах.",
          ],
          [
            "Check pressure monthly and before long trips.",
            "Inspect tires every 10,000 km.",
            "Balance wheels every 10,000–15,000 km.",
            "Align every 20,000 km or if steering pulls.",
            "Measure pressure on cold tires.",
          ],
        ),
        replacement: TL(
          [
            `O'rtacha tavsiya — ${spec?.tire.replacementKm ?? "40 000–50 000 km"}.`,
            "Protektor 1,6 mm dan past bo'lsa darhol almashtiring.",
            "Yon devor yorig'i yoki shishishida almashtiring.",
          ],
          [
            `Средняя рекомендация — ${spec?.tire.replacementKm ?? "40 000–50 000 км"}.`,
            "Ниже 1,6 мм — заменить немедленно.",
            "Меняйте при трещинах или вздутиях боковины.",
          ],
          [
            `Average replacement — ${spec?.tire.replacementKm ?? "40,000–50,000 km"}.`,
            "Below 1.6 mm — replace immediately.",
            "Replace on sidewall cracks or bulges.",
          ],
        ),
        heavyUsage: TL(
          [
            "Yomon yo'l, og'ir yuk, issiq/sovuq — tez-tez tekshiring.",
            "Har 10 000 km da shinalarni almashtirib qo'ying.",
          ],
          ["Плохие дороги, груз, жара/холод — чаще проверка.", "Ротация каждые 10 000 км."],
          [
            "Rough roads, heavy loads, hot/cold — inspect more often.",
        ...
        warnings: TL(
          [
            ...
            "Notekis yeyilish.",
            "Bosim tez pasayadi.",
            "Yon devorda yoriq/shishish.",
            "Yo'l shovqini oshgan.",
          ],
          [
            "Уводит в сторону.",
            "Вибрация руля.",
        ...
        usefulTips: TL(
          [
            ...
            "Protektor: 6–8 mm yaxshi · 3–4 mm ehtiyot · <1,6 mm xavfli.",
          ],
          [
            "Низкое давление увеличивает расход.",
            "На холоде давление падает.",
            "Протектор: 6–8 мм отлично · 3–4 мм внимание · <1,6 мм опасно.",
          ],
          [
            "Low pressure raises fuel use.",
        ...
        summaryReplacement: T(
          spec?.tire.replacementKm ?? "40 000–50 000 km yoki shikastlanganda.",
          spec?.tire.replacementKm ?? "40 000–50 000 км или при повреждении.",
          spec?.tire.replacementKm ?? "40,000–50,000 km or if damaged.",
        ),
    ...
    case "oil":
      return {
        ...
        intervals: [
          {
            label: T("Almashtirish", "Замена", "Replacement"),
            value: T("10 000 km yoki 12 oy", "10 000 км или 12 мес.", "10,000 km or 12 mo"),
            tone: "accent",
          },
          {
          ...
          {
            label: T("Daraja", "Уровень", "Level check"),
        ...
        inspection: TL(
          [
            ...
            "Har servisda rang va hidini baholang.",
            "Sizib chiqishlarni tekshiring.",
          ],
          [
            "Уровень масла — раз в месяц.",
            "На каждом ТО оценивайте цвет и запах.",
            "Проверяйте утечки.",
          ],
          [
            "Check oil level monthly.",
            "Assess color and smell at every service.",
            "Check for leaks.",
          ],
        ),
        replacement: TL(
          [
            "Normal — har 10 000 km.",
            "Og'ir sharoitda — 5 000–7 000 km.",
            "Filtrni doim moy bilan birga almashtiring.",
          ],
          [
            "Обычно — каждые 10 000 км.",
            "В тяжёлых условиях — 5 000–7 000 км.",
            "Фильтр меняйте вместе с маслом.",
          ],
          [
            "Normal — every 10,000 km.",
            "Heavy usage — 5,000–7,000 km.",
        ...
        usefulTips: TL(
          [
            "Faqat tavsiya qilingan qovushqoqlikdan foydalaning.",
            "Turli moylarni aralashtirmang.",
            "Kech almashtirish dvigatel umrini qisqartiradi.",
          ],
          [
            "Используйте только рекомендованную вязкость.",
            "Не смешивайте типы масла без нужды.",
            "Опоздание сокращает ресурс двигателя.",
          ],
          [
            "Use only recommended viscosity.",
            "Do not mix oil types unnecessarily.",
            "Late replacement shortens engine life.",
          ],
        ),
        summaryInspection: T(
