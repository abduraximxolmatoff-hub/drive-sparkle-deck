...
export const COBALT_PART_INFO: Record<string, CobaltPartInfo> = {
  tires: {
    ...
    intervals: [
      {
        ...
        value: T(
          "Old 32–33 · Orqa 30–32 PSI",
          "Перед 32–33 · Зад 30–32 PSI",
          "F 32–33 · R 30–32 PSI",
        ),
        tone: "accent",
      },
    ...
    heavyUsage: TL(
      [
        "Yomon yo'l, og'ir yuk, issiq va sovuq ob-havoda shinalarni tez-tez tekshiring.",
        "Har 10 000 km da g'ildiraklarni almashtirib qo'yish bir tekis yeyilishga yordam beradi.",
      ],
      [
        "В тяжёлых условиях (плохие дороги, груз, жара/холод) проверяйте чаще.",
        "Ротация колёс каждые 10 000 км — для равномерного износа.",
      ],
      [
        "Rough roads, heavy loads, hot/cold weather — inspect more often.",
    ...
    warnings: TL(
      [
        ...
        "Yon devorda yoriq yoki shishish.",
        "Yo'l shovqini oshib ketgan.",
      ],
      [
        ...
        "Трещины или вздутия боковины.",
        "Громкий шум от дороги.",
      ],
      [
    ...
    usefulTips: TL(
      [
        ...
        "Noto'g'ri bosim tormoz samarasini pasaytiradi.",
        "Sovuq havoda bosim pasayadi.",
        "Issiqda bosim biroz oshadi.",
        "Protektor: 6–8 mm yaxshi · 3–4 mm ehtiyot bo'l · <1,6 mm xavfli.",
      ],
      [
        "Низкое давление повышает расход топлива.",
        "Неверное давление снижает эффективность тормозов.",
        "На холоде давление падает.",
        "В жару давление слегка растёт.",
        "Протектор: 6–8 мм — отлично · 3–4 мм — внимание · <1,6 мм — опасно.",
      ],
      [
        "Low pressure increases fuel consumption.",
        "Wrong pressure reduces braking efficiency.",
        "Cold weather lowers pressure.",
        "Hot weather slightly raises pressure.",
        "Tread: 6–8 mm good · 3–4 mm caution · <1.6 mm critical.",
      ],
    ),
    summaryInspection: T(
      "Oyiga 1 marta + har 10 000 km.",
      "Раз в месяц + каждые 10 000 км.",
      "Monthly + every 10,000 km.",
    ),
    summaryReplacement: T(
      "40 000–50 000 km yoki shikastlanganda.",
      "40 000–50 000 км или при повреждении.",
      "40,000–50,000 km or if damaged.",
    ),
  ...
  windows: {
    ...
    inspection: TL(
      [
        "Old va yon oynalarni muntazam tekshiring.",
        "Har servisda tozalagich va yuvish tizimini tekshiring.",
        "Yuvish suyuqligi darajasini oyiga 1 marta tekshiring.",
        "Qish va yomg'ir mavsumidan oldin cho'tkalarni alohida tekshiring.",
      ],
      [
        "Регулярно проверяйте лобовое и боковые стёкла.",
        "На каждом ТО проверяйте дворники и омыватель.",
        "Уровень омывайки — раз в месяц.",
        "Перед зимой и сезоном дождей — отдельная проверка щёток.",
      ],
      [
        "Inspect windshield and side windows regularly.",
        "Check wipers and washer system every service.",
        "Check washer fluid level monthly.",
        "Before winter and rainy season — inspect wiper blades carefully.",
      ],
    ),
    replacement: TL(
      [
        "Cho'tkalar — har 10 000–15 000 km yoki 6–12 oyda.",
        "Iz qoldirsa yoki shovqin chiqarsa darhol almashtiring.",
        "Yoriq ko'rinishga to'sqinlik qilsa shishani ta'mirlang yoki almashtiring.",
      ],
      [
        "Дворники — каждые 10 000–15 000 км или 6–12 мес.",
        "Если оставляют полосы или шумят — заменить сразу.",
        "Трещина, мешающая обзору — ремонт или замена стекла.",
      ],
      [
        "Wiper blades — every 10,000–15,000 km or 6–12 months.",
        "Replace immediately if they leave streaks or make noise.",
        "Repair or replace glass if cracks affect visibility.",
      ],
    ),
    heavyUsage: TL(
      [
        "Yomg'ir, qor, chang va loy sharoitida cho'tkalarni tez-tez tekshiring.",
        "Qishda muzlagan cho'tkani kuch bilan ko'tarmang.",
      ],
      [
        "В дождь, снег, пыль и грязь — чаще проверка.",
        "Зимой не отрывайте примёрзшие дворники силой.",
      ],
      [
        "Rain, snow, dust and mud — check more often.",
        "In winter do not force frozen wiper blades.",
      ],
    ),
    warnings: TL(
      [
        "Tozalagich iz qoldiradi.",
        "Yuvish suyuqligi purkamaydi.",
        "Shishada yoriq yoki chip.",
        "Tunda yoki yomg'irda ko'rinish yomon.",
        "Tozalagich shovqini.",
        "Cho'tka shishaga sakraydi.",
      ],
      [
        "Дворник оставляет полосы.",
        "Омыватель не льёт.",
        "Скол или трещина на стекле.",
        "Плохая видимость ночью/в дождь.",
        "Шум дворников.",
        "Дворник прыгает по стеклу.",
      ],
      [
        "Wipers leave marks.",
        "Washer fluid does not spray.",
        "Glass has cracks or chips.",
        "Poor visibility at night or in rain.",
        "Wiper blades make noise.",
        "Wipers jump on the glass.",
      ],
    ),
    usefulTips: TL(
      [
        "Quruq iflos shishada cho'tkani ishlatmang.",
        "Faslga mos yuvish suyuqligidan foydalaning.",
        "Qishda muzlagan cho'tkani majburlamang.",
        "Shishani ichi va tashqarisidan muntazam tozalang.",
      ],
      [
        "Не включайте дворники на сухом грязном стекле.",
        "Используйте сезонную омывайку.",
        "Не дёргайте примёрзшие дворники.",
        "Регулярно мойте стекло снаружи и изнутри.",
      ],
      [
        "Do not use wipers on dry, dirty glass.",
        "Use season-appropriate washer fluid.",
        "Do not force frozen wipers.",
        "Clean the windshield regularly inside and out.",
      ],
    ),
    summaryInspection: T(
      "Har servisda + oyiga.",
      "На каждом ТО + ежемесячно.",
      "Every service + monthly.",
    ),
    summaryReplacement: T(
      "Cho'tka — 10–15 000 km / 6–12 oy.",
      "Дворники — 10–15 000 км / 6–12 мес.",
      "Wipers — 10–15,000 km / 6–12 mo.",
    ),
    badges: ["inspect", "replace", "safety"],
  },
  ...
  oil: {
    ...
    inspection: TL(
      [
        "Moy darajasini oyiga 1 marta tekshiring.",
        "Har servisda moy holatini (rang, hid) baholang.",
        "Har servisda sizib chiqishlarni tekshiring.",
        "Moy ogohlantirish chirog'iga e'tibor bering.",
      ],
      [
        "Уровень масла — раз в месяц.",
        "На каждом ТО оценивайте состояние масла (цвет, запах).",
        "На каждом ТО проверяйте утечки.",
        "Следите за индикатором давления масла.",
      ],
      [
        "Check oil level once a month.",
        "Assess oil condition (color, smell) at every service.",
        "Check for leaks at every service.",
        "Watch the oil warning light.",
      ],
    ),
    replacement: TL(
      [
        "Normal sharoitda har 10 000 km da moy va moy filtri.",
        "Og'ir foydalanishda — har 5 000–7 000 km da.",
        "Moy qora, kuygan hidli yoki tez kamaysa oldinroq almashtiring.",
        "Moy filtrini doim moy bilan birga almashtiring.",
      ],
      [
        "В обычных условиях — масло и фильтр каждые 10 000 км.",
        "В тяжёлых условиях — каждые 5 000–7 000 км.",
        "Если масло тёмное, пахнет гарью или быстро уходит — раньше.",
        "Масляный фильтр меняйте вместе с маслом.",
      ],
      [
        "Normal conditions: oil and filter every 10,000 km.",
        "Heavy usage: every 5,000–7,000 km.",
        "Replace earlier if oil is dark, smells burnt or drops quickly.",
        "Always replace oil filter together with engine oil.",
      ],
    ),
    heavyUsage: TL(
      [
    ...
    warnings: TL(
      [
        ...
        "Dvigatel ovozi oshgan.",
        "Mashina ostida moy izi.",
        "Dvigatel qizib ketishi.",
      ],
      [
        "Индикатор давления масла.",
        "Низкий уровень масла.",
        "Тёмное или горелое масло.",
        "Усиленный звук двигателя.",
    ...
    usefulTips: TL(
      [
        "Faqat ishlab chiqaruvchi tavsiya qilgan moy qovushqoqligidan foydalaning.",
        "Moy filtrini doim birga almashtiring.",
        "Turli xil moylarni shart bo'lmasa aralashtirmang.",
        "Kech almashtirish dvigatel umrini qisqartiradi.",
      ],
      [
        "Используйте только рекомендованную производителем вязкость масла.",
        "Фильтр меняйте всегда вместе с маслом.",
        "Не смешивайте разные типы масла без необходимости.",
        "Запоздалая замена сокращает ресурс двигателя.",
      ],
      [
        "Always use the manufacturer-recommended oil viscosity.",
        "Replace the oil filter together with engine oil.",
        "Do not mix oil types unnecessarily.",
        "Late replacement reduces engine life.",
      ],
    ),
    summaryInspection: T(
      "Oyiga 1 marta + har servisda.",
      "Раз в месяц + на каждом ТО.",
      "Monthly + every service.",
    ),
    summaryReplacement: T(
      "10 000 km · og'ir sharoitda 5–7 000 km.",
      "10 000 км · в тяжёлых условиях 5–7 000 км.",
      "10,000 km · 5–7,000 km in heavy usage.",
    ),
  ...
  engine: {
    ...
    inspection: TL(
      [
        "Har servisda dvigatelning umumiy holatini tekshiring.",
        "Sovutish, yoqilg'i, moylash va konditsioner germetikligini muntazam tekshiring.",
        "Shlanglar va ulanishlarni har servisda ko'zdan kechiring.",
        "PCV tizimini muntazam tekshiring.",
        "EVAP tizimi va bug' shlanglarini tekshiring.",
      ],
      [
        "На каждом ТО проверяйте общее состояние двигателя.",
        "Регулярно проверяйте герметичность охлаждения, топлива, смазки и кондиционера.",
        "Шланги и соединения — на каждом ТО.",
        "Систему PCV — регулярно.",
        "Систему EVAP и паровые шланги — регулярно.",
      ],
      [
        "Check overall engine condition at every service.",
        "Regularly check tightness of cooling, fuel, lubrication and A/C systems.",
        "Inspect hoses and connections every service.",
        "Inspect the PCV system regularly.",
        "Inspect EVAP system and vapor hoses regularly.",
      ],
    ),
    replacement: TL(
      [
        "Svechalar — taxminan 40 000–50 000 km da, holat va reglament bo'yicha.",
        "Yordamchi (generator/AC) tasma — har servisda tekshirish, yeyilgan/yorilgan bo'lsa almashtirish.",
        "Yoqilg'i va havo komponentlari — reglament yoki holat bo'yicha.",
      ],
      [
        "Свечи — около 40 000–50 000 км по регламенту и состоянию.",
        "Ремень навесного оборудования — проверка на каждом ТО, замена при износе/трещинах.",
        "Топливные и воздушные компоненты — по регламенту/состоянию.",
      ],
      [
        "Spark plugs — around 40,000–50,000 km depending on condition and regulation.",
        "Drive/auxiliary belt — inspect every service, replace if worn, cracked or noisy.",
        "Fuel/air components — per regulation or condition.",
      ],
    ),
    heavyUsage: TL(
      [
    ...
    usefulTips: TL(
      [
        "Panel ogohlantirish chiroqlarini e'tiborsiz qoldirmang.",
        "Sovuq havoda dvigatelni yengilroq isiting.",
        "Qizib ketgan dvigatel bilan uzoq yurmang.",
        "Sifatli yoqilg'i va to'g'ri moydan foydalaning.",
        "G'ayritabiiy ovozni erta diagnostika qiling.",
      ],
      [
        "Не игнорируйте сигнальные лампы.",
        "В холод прогревайте двигатель мягко.",
        "Не ездите долго на перегретом двигателе.",
        "Используйте качественное топливо и правильное масло.",
        "Диагностируйте необычные звуки заранее.",
      ],
      [
        "Never ignore dashboard warning lights.",
        "Warm the engine up gently in cold weather.",
        "Do not drive long with an overheating engine.",
        "Use quality fuel and the correct engine oil.",
        "Diagnose unusual noises early.",
      ],
    ),
    summaryInspection: T(
      "Har servisda + muntazam shlang/EVAP/PCV tekshiruvi.",
      "На каждом ТО + регулярно шланги/EVAP/PCV.",
      "Every service + regular hose/EVAP/PCV checks.",
    ),
    summaryReplacement: T(
      "Svechalar 40–50 000 km · holat bo'yicha qismlar.",
      "Свечи 40–50 000 км · детали по состоянию.",
      "Plugs 40–50,000 km · other parts by condition.",
    ),
    badges: ["inspect", "replace", "safety"],
  },
  ...
  battery: {
    ...
    inspection: TL(
      [
        "Akkumulyator va elektr jihozlari har servisda tekshiriladi.",
        "Klemmalarda korroziya bor-yo'qligini tekshiring.",
        "Voltajni har 3 oyda tekshiring.",
        "Qishdan oldin akkumulyator holatini sinab ko'ring.",
      ],
      [
        "АКБ и электрооборудование — на каждом ТО.",
        "Проверяйте клеммы на коррозию.",
        "Напряжение — каждые 3 месяца.",
        "Перед зимой — тест состояния АКБ.",
      ],
      [
        "Battery and electrical equipment — checked every service.",
        "Inspect terminals for corrosion.",
        "Check voltage every 3 months.",
        "Before winter — test battery condition.",
      ],
    ),
    replacement: TL(
      [
        "O'rtacha xizmat muddati: 2–4 yil.",
        "Quvvatni ushlay olmasa yoki start ishonchsiz bo'lsa almashtiring.",
        "3 yildan keyin muntazam test tavsiya etiladi.",
      ],
      [
        "Средний срок: 2–4 года.",
        "Меняйте, если не держит заряд или ненадёжный пуск.",
        "После 3 лет — регулярный тест.",
      ],
      [
        "Average lifespan: 2–4 years.",
        "Replace if it cannot hold charge or starting is unreliable.",
        "After 3 years — regular testing recommended.",
      ],
    ),
    heavyUsage: TL(
    ...
    warnings: TL(
      [
        "Sekin start.",
        "Xira faralar.",
        "Akkumulyator ogohlantirish chirog'i.",
        "Klemmalarda korroziya.",
        "Elektronika kuchsiz ishlaydi.",
        "Turishdan keyin mashina o'tirib qoladi.",
      ],
      [
        "Медленный пуск.",
        "Тусклые фары.",
        "Индикатор АКБ.",
        "Коррозия на клеммах.",
        "Слабая работа электроники.",
        "После стоянки не заводится.",
      ],
      [
        "Slow engine start.",
        "Dim headlights.",
        ...
        "Electrical systems work weakly.",
        "Vehicle does not start after parking.",
      ],
    ),
    usefulTips: TL(
      [
        "Klemmalarni toza va mahkam saqlang.",
        "Dvigatel o'chirilganda chiroqlarni qoldirmang.",
        "Qishda kuchsiz akkumulyator tez ishdan chiqadi.",
        "Qisqa safarlar akkumulyatorni to'liq quvvatlamasligi mumkin.",
      ],
      [
        "Держите клеммы чистыми и затянутыми.",
        "Не оставляйте свет при выключенном двигателе.",
        "Зимой слабые АКБ отказывают чаще.",
        "Короткие поездки не дают полному заряду.",
      ],
      [
        "Keep terminals clean and tight.",
        "Do not leave lights on with engine off.",
        "Weak batteries fail more often in winter.",
        "Short trips may not fully recharge the battery.",
      ],
    ),
    summaryInspection: T(
      "Har servisda + 3 oyda voltaj.",
      "На каждом ТО + напряжение раз в 3 мес.",
      "Every service + voltage every 3 months.",
    ),
    summaryReplacement: T(
      "2–4 yil yoki quvvat ushlay olmasa.",
      "2–4 года или при потере заряда.",
      "2–4 years or when it cannot hold charge.",
    ),
  ...
  brakes: {
    ...
    inspection: TL(
      [
        "Tormoz tizimi har servisda tekshiriladi.",
        "Old kolodka va disklar — har servisda.",
        "Orqa kolodka, disk/baraban va qoplamalar — har servisda.",
        "Tormoz naylari va ulanishlari — muntazam.",
        "Pedalning bo'sh harakati — tekshirish.",
        "Qo'l (to'xtab turish) tormozini muntazam tekshiring.",
      ],
      [
        "Тормозная система — на каждом ТО.",
        "Передние колодки и диски — на каждом ТО.",
        "Задние колодки, диски/барабаны и накладки — на каждом ТО.",
        "Шланги и соединения — регулярно.",
        "Свободный ход педали — проверка.",
        "Стояночный тормоз — регулярно.",
      ],
      [
        "Brake system — every service.",
        "Front pads and discs — every service.",
        "Rear pads, discs/drums and linings — every service.",
        "Brake hoses and connections — regularly.",
        "Brake pedal free movement — check.",
        "Parking brake — check regularly.",
      ],
    ),
    replacement: TL(
      [
        "Old tormoz kolodkalari: odatda 25 000–40 000 km.",
        "Orqa kolodka/baraban: odatda 40 000–60 000 km.",
        "Tormoz suyuqligi: har 2 yilda yoki reglament bo'yicha.",
        "Yeyilgan, deformatsiyalangan disk va barabanlarni almashtiring.",
      ],
      [
        "Передние колодки: обычно 25 000–40 000 км.",
        "Задние колодки/барабаны: обычно 40 000–60 000 км.",
        "Тормозная жидкость: каждые 2 года или по регламенту.",
        "Изношенные/деформированные диски и барабаны — заменить.",
      ],
      [
        "Front brake pads: usually 25,000–40,000 km.",
        "Rear pads/drums: usually 40,000–60,000 km.",
        "Brake fluid: every 2 years or per regulation.",
        "Replace worn or warped discs and drums.",
      ],
    ),
    heavyUsage: TL(
    ...
    warnings: TL(
      [
        "G'ichirlash.",
        "Maydalanish ovozi.",
        "Tormozlashda titrash.",
        "To'xtash masofasi uzayishi.",
        "Yumshoq pedal.",
        "Tormoz suyuqligi sizishi.",
        "Tormoz ogohlantirish chirog'i.",
      ],
      [
        "Скрип.",
        "Скрежет.",
    ...
    usefulTips: TL(
      [
        "Tormoz servisini kechiktirmang.",
        "Iloji boricha tajovuzkor tormoz bermang.",
        "Tormoz holati o'zgarsa darhol tekshiring.",
        "Tormoz muammolari — bevosita xavfsizlik masalasi.",
      ],
      [
        "Не откладывайте обслуживание тормозов.",
        "По возможности избегайте резких торможений.",
        "Изменение поведения тормозов — сразу на проверку.",
        "Проблемы тормозов критичны для безопасности.",
      ],
      [
        "Do not delay brake service.",
        "Avoid aggressive braking when possible.",
        "If braking feels different — inspect immediately.",
        "Brake system issues are safety-critical.",
      ],
    ),
    summaryInspection: T("Har servisda.", "На каждом ТО.", "Every service."),
    summaryReplacement: T(
      "Old 25–40k · Orqa 40–60k · Suyuqlik 2 yilda.",
      "Перед 25–40k · Зад 40–60k · Жидкость 2 года.",
      "Front 25–40k · Rear 40–60k · Fluid 2 yr.",
    ),
    badges: ["inspect", "replace", "safety"],
  },
  ...
  headlights: {
    partId: "headlights",
    title: T(
      "Faralar va yoritish tizimi",
      "Фары и система освещения",
    ...
    intervals: [
      ...
      },
      {
        ...
        value: T(
          "Har 20 000 km / urilishdan keyin",
          "Каждые 20 000 км / после удара",
          "Every 20,000 km / after impact",
        ),
        tone: "warn",
      },
    ],
  ...
  cooling: {
    ...
    inspection: TL(
      [
        "Antifriz darajasini har servisda tekshiring.",
        "Radiator, shlanglar va ulanishlarni har servisda ko'zdan kechiring.",
        "Sovutish tizimi germetikligini muntazam tekshiring.",
        "Yoz va qish oldidan antifriz holatini tekshiring.",
      ],
      [
        "Уровень антифриза — на каждом ТО.",
        "Радиатор, шланги и соединения — на каждом ТО.",
        "Герметичность системы — регулярно.",
        "Перед летом и зимой — проверка состояния антифриза.",
      ],
      [
        "Check coolant level at every service.",
        "Inspect radiator, hoses and connections at every service.",
        "Regularly check cooling system tightness.",
        "Check coolant condition before summer and winter.",
      ],
    ),
    replacement: TL(
      [
        "Antifriz / sovutgich: taxminan 40 000–50 000 km da yoki reglament bo'yicha.",
        "Antifriz ifloslangan yoki sifati pasaysa darhol almashtiring.",
        "Shikastlangan shlang yoki oqayotgan qismlarni darhol almashtiring.",
      ],
      [
        "Антифриз: около 40 000–50 000 км или по регламенту.",
        "При загрязнении или ухудшении свойств — сразу.",
        "Повреждённые шланги или протекающие части — немедленно.",
      ],
      [
        "Coolant / antifreeze: around 40,000–50,000 km or per regulation.",
        "Replace immediately if coolant is contaminated or loses quality.",
        "Replace damaged hoses or leaking parts immediately.",
      ],
    ),
    heavyUsage: TL(
    ...
    warnings: TL(
      [
        "Harorat ko'rsatkichi ko'tariladi.",
        "Antifriz darajasi tez-tez pasayadi.",
        "Mashina ostida antifriz sizishi.",
        "Kapot ostidan bug'.",
        "Dvigatel yonida shirin hid.",
        "Dvigatel qizib ketadi.",
      ],
      [
        "Растёт температура.",
        "Часто падает уровень антифриза.",
        "Течь под машиной.",
        "Пар из-под капота.",
        "Сладкий запах.",
        "Перегрев.",
    ...
    usefulTips: TL(
      [
        "Dvigatel issiqligida radiator qopqog'ini hech qachon ochmang.",
        "Faqat to'g'ri turdagi antifrizdan foydalaning.",
        "Qizib ketgan dvigatel bilan haydamang.",
        "Uzoq safardan oldin antifrizni tekshiring.",
      ],
      [
        "Никогда не открывайте крышку радиатора на горячем двигателе.",
        "Используйте только подходящий тип антифриза.",
        "Не ездите на перегретом двигателе.",
        "Перед длительной поездкой — проверка антифриза.",
      ],
      [
        "Never open the radiator cap when the engine is hot.",
        "Use only the correct antifreeze type.",
        "Do not drive with an overheating engine.",
        "Check coolant before long trips.",
      ],
    ),
    summaryInspection: T(
      "Har servisda + mavsumdan oldin.",
      "На каждом ТО + перед сезоном.",
      "Every service + before each season.",
    ),
    summaryReplacement: T(
      "Antifriz — 40–50 000 km.",
      "Антифриз — 40–50 000 км.",
      "Coolant — 40–50,000 km.",
    ),
    badges: ["inspect", "replace", "safety"],
  },
  ...
  airfilter: {
    ...
    inspection: TL(
      [
        "Har servisda havo filtrini tekshiring.",
        "Changli sharoitda tez-tez tekshiring.",
        "Reglament filtrini servis intervaliga ko'ra tekshirish va almashtirish elementi sifatida belgilaydi.",
      ],
      [
        "На каждом ТО — проверка фильтра.",
        "В пыльных условиях — чаще.",
        "По регламенту: и проверка, и замена согласно интервалу/состоянию.",
      ],
      [
        "Inspect the air filter at every service.",
        "Inspect more frequently in dusty conditions.",
        "Regulation marks it as both an inspection and replacement item depending on interval and condition.",
      ],
    ),
    replacement: TL(
      [
        "Odatda har 10 000–15 000 km da almashtiring.",
        "Changli yo'l yoki ko'rinishda iflos bo'lsa oldinroq almashtiring.",
        "Tiqilib qolgan, shikastlangan yoki moy bilan ifloslangan filtrni almashtiring.",
      ],
      [
        "Обычно — каждые 10 000–15 000 км.",
        "В пыли или при видимом загрязнении — раньше.",
        "Забитый, повреждённый или замасленный — заменить.",
      ],
      [
        "Usually every 10,000–15,000 km.",
        "Replace earlier on dusty roads or if visibly dirty.",
        "Replace if clogged, damaged or oil-contaminated.",
      ],
    ),
    heavyUsage: TL(
      [
        "Changli yo'llar filtr umrini qisqartiradi.",
        "Shahar tirbandligi va qurilish hududlarida tez-tez almashtiring.",
      ],
      ["Пыльные дороги сокращают срок службы.", "Пробки и стройка — меняйте чаще."],
      [
        "Dusty roads shorten filter life.",
        "Urban traffic and construction zones — replace more often.",
      ],
    ),
    warnings: TL(
      [
        ...
        "Tezlanish susayishi.",
        "Dvigatel ovozining qo'pollashi.",
        "Iflos filtr elementi.",
        "Dvigatel javobi sustlashgan.",
      ],
      [
        "Повышенный расход топлива.",
        "Слабый разгон.",
        "Грубый звук двигателя.",
        "Грязный элемент.",
        "Замедленная реакция двигателя.",
      ],
      [
    ...
    usefulTips: TL(
      [
        "Changli yo'llar filtr umrini qisqartiradi.",
        "Iflos filtr dvigatel samaradorligini pasaytiradi.",
        "Qog'oz filtrlarni — ishlab chiqaruvchi ruxsat bermasa — yuvmang.",
        "Faqat to'g'ri turdagi filtr bilan almashtiring.",
      ],
      [
        "Пыль сокращает ресурс фильтра.",
        "Грязный фильтр снижает КПД двигателя.",
        "Бумажные фильтры не мойте без разрешения производителя.",
        "Меняйте только на фильтр правильного типа.",
      ],
      [
        "Dusty roads shorten air filter life.",
        "A dirty filter reduces engine efficiency.",
        "Do not wash paper filters unless the manufacturer allows it.",
        "Replace only with the correct filter type.",
      ],
    ),
    summaryInspection: T(
      "Har servisda; changda tez-tez.",
      "На каждом ТО; в пыли — чаще.",
      "Every service; more often in dust.",
    ),
  ...
  suspension: {
    ...
    inspection: TL(
      [
        "Podveska va shassi har servisda tekshiriladi.",
        "Rul g'ildiragi va mexanizmi — har servisda.",
        "Rul gidrokuchaytirgichi suyuqligi, naylari va ulanishlari — tekshirish.",
        "Shassi va kuzov rezbali ulanishlari — tekshirish va mahkamlash.",
        "Burchaklar normadan tashqarida bo'lsa yoki rul o'zgarsa — tekshirish.",
      ],
      [
        "Подвеска и шасси — на каждом ТО.",
        "Руль и рулевой механизм — на каждом ТО.",
        "ГУР: жидкость, шланги, соединения — проверка.",
        "Резьбовые соединения шасси/кузова — проверка и подтяжка.",
        "При отклонениях углов или изменении руля — проверка.",
      ],
      [
        "Suspension and chassis — every service.",
        "Steering wheel and mechanism — every service.",
        "Power steering fluid, hoses and connections — inspect.",
        "Chassis and body threaded connections — inspect and tighten if needed.",
        "Wheel alignment — if values deviate or steering changes.",
      ],
    ),
    replacement: TL(
      [
        "Yeyilgan bushinglar, sharli tayanchlar yoki amortizatorlarni almashtiring.",
        "Amortizatorlar — odatda 60 000–80 000 km da diqqat talab qiladi.",
        "Yomon yo'l shikastlasa qismlarni oldinroq almashtiring.",
      ],
      [
        "Меняйте изношенные сайлент-блоки, шаровые, амортизаторы.",
        "Амортизаторы — обычно требуют внимания к 60 000–80 000 км.",
        "При повреждениях от плохих дорог — раньше.",
      ],
      [
        "Replace worn bushings, ball joints or shock absorbers when needed.",
        "Shock absorbers often require attention around 60,000–80,000 km depending on roads.",
        "Replace parts earlier if damaged by rough roads.",
      ],
    ),
    heavyUsage: TL(
    ...
    warnings: TL(
      [
        ...
        "Rul bo'sh his qilinadi.",
        "Ortiqcha titrash.",
        "Yomon barqarorlik.",
        "Mashina haddan tashqari sakraydi.",
      ],
      [
        "Стук.",
        "Увод в сторону.",
    ...
    usefulTips: TL(
      [
        "Yomon yo'llar podveska umrini qisqartiradi.",
        "Tezlikda chuqurlardan o'tmang.",
        "Kuchli zarbadan keyin burchaklarni tekshiring.",
        "Notekis shina yeyilishi — podveska yoki burchaklar muammosi belgisi.",
      ],
      [
        "Плохие дороги сокращают срок службы подвески.",
        "Не пролетайте ямы на скорости.",
        "После сильного удара — проверка углов.",
        "Неравномерный износ шин — признак подвески/углов.",
      ],
      [
        "Bad roads shorten suspension life.",
        "Avoid hitting potholes at speed.",
        "Check alignment after a strong impact.",
        "Uneven tire wear may signal a suspension or alignment issue.",
      ],
    ),
    summaryInspection: T(
      "Har servisda + kuchli zarbadan keyin.",
      "На каждом ТО + после сильных ударов.",
      "Every service + after strong impacts.",
    ),
    summaryReplacement: T(
      "Amortizator 60–80 000 km · qismlar holat bo'yicha.",
      "Амортизаторы 60–80 000 км · детали по состоянию.",
      "Shocks 60–80,000 km · parts by condition.",
    ),
  ...
  cabin_filter: {
    ...
    intervals: [
      ...
      },
      {
        label: T("Almashtirish", "Замена", "Replacement"),
        value: T(
          "Har 20 000 km / yiliga",
          "Каждые 20 000 км / раз в год",
          "Every 20,000 km / yearly",
        ),
        tone: "warn",
      },
    ],
    ...
    summaryInspection: T("Har 10 000 km da.", "Каждые 10 000 км.", "Every 10,000 km."),
    summaryReplacement: T(
      "Har 20 000 km yoki yiliga.",
      "Каждые 20 000 км или раз в год.",
      "Every 20,000 km or yearly.",
    ),
    badges: ["inspect", "replace"],
  },
  ...
  spark_plugs: {
    ...
    summaryReplacement: T(
      "25 000 km · og'irda 15 000 km / 1 yil.",
      "25 000 км · в тяжёлых 15 000 км / 1 год.",
      "25,000 km · heavy usage 15,000 km / 1 year.",
    ),
    badges: ["inspect", "replace", "heavy"],
  },
  ...
  brake_fluid: {
    ...
    summaryInspection: T("Har 10 000 km da.", "Каждые 10 000 км.", "Every 10,000 km."),
    summaryReplacement: T(
      "Har 32 500 km yoki 2 yilda.",
      "Каждые 32 500 км или 2 года.",
      "Every 32,500 km or 2 years.",
    ),
    badges: ["inspect", "replace", "safety"],
  },
  ...
  transmission: {
    ...
    summaryInspection: T(
      "MКPP: har servisda · АКPP: reglament bo'yicha.",
      "МКПП: на каждом ТО · АКПП: по регламенту.",
      "MT: every service · AT: per regulation.",
    ),
    summaryReplacement: T(
      "АКPP: ~105 000 km · og'irda 70 000 km.",
      "АКПП: ~105 000 км · в тяжёлых 70 000 км.",
      "AT: ~105,000 km · heavy 70,000 km.",
    ),
    badges: ["inspect", "replace", "heavy"],
  },
  ...
  steering: {
    ...
    summaryInspection: T(
      "Har servisda + burchaklar har 20 000 km.",
      "На каждом ТО + углы каждые 20 000 км.",
      "Every service + alignment every 20,000 km.",
    ),
    summaryReplacement: T(
      "Holat bo'yicha · shikastlanganda darhol.",
      "По состоянию · при повреждении — сразу.",
      "By condition · on damage — immediately.",
    ),
    badges: ["inspect", "safety"],
  },
  ...
  exhaust: {
    ...
    summaryInspection: T("Har servisda.", "На каждом ТО.", "Every service."),
    summaryReplacement: T(
      "Korroziya / sizishda — darhol.",
      "При коррозии/утечке — сразу.",
      "On corrosion/leaks — immediately.",
    ),
    badges: ["inspect", "safety"],
  },
};
...
export const COBALT_FUTURE_PART_INFO: Record<string, CobaltPartInfo> = {
  fuelHoses: {
    partId: "fuelHoses",
    title: T(
      "Yoqilg'i shlang va ulanishlari",
      "Топливные шланги и соединения",
    ...
    inspection: TL(
      ["Har servisda tekshiring."],
      ["Проверка на каждом ТО."],
      ["Inspect every service."],
    ),
    replacement: TL(
      ["Sizish yoki yoriq bo'lsa darhol almashtiring."],
      ["Меняйте при утечке или трещинах."],
      ["Replace immediately if leaking or cracked."],
    ),
    heavyUsage: TL(
      ["Issiq va vibratsiya shlanglarning eskirishini tezlashtiradi."],
      ["Жара и вибрация ускоряют износ."],
      ["Heat and vibration accelerate hose wear."],
    ),
    warnings: TL(
      ["Yoqilg'i hidi.", "Mashina ostida nam dog'.", "Bosim yo'qolishi."],
      ["Запах топлива.", "Влажные пятна под машиной.", "Падение давления."],
      ["Fuel smell.", "Wet spots under the vehicle.", "Pressure loss."],
    ),
    summaryInspection: T("Har servisda.", "На каждом ТО.", "Every service."),
    summaryReplacement: T(
      "Sizish/yoriqlarda — darhol.",
      "При утечках/трещинах — сразу.",
      "On leaks/cracks — immediately.",
    ),
    badges: ["inspect", "replace", "safety"],
  },
  evap: {
    ...
    inspection: TL(
      ["Bug' shlanglari va kanistrni tekshiring.", "Yoqilg'i bug'i nazorat tizimini tekshiring."],
      ["Проверка паровых шлангов и канистры.", "Проверка системы контроля паров."],
      ["Inspect vapor hoses and canister.", "Check fuel vapor control system."],
    ),
    replacement: TL(
      ["Shikastlangan komponentlarni almashtiring."],
      ["Меняйте повреждённые компоненты."],
      ["Replace damaged components."],
    ),
    heavyUsage: TL(
      ["Yoqilg'i hidlari bo'lsa darhol diagnostika."],
      ["При запахе топлива — диагностика."],
      ["Diagnose immediately on fuel smell."],
    ),
    warnings: TL(
      ["Check Engine.", "Yoqilg'i hidi.", "Tank qopqog'i ogohlantirishi."],
      ["Check Engine.", "Запах топлива.", "Предупреждение о крышке бака."],
      ["Check Engine.", "Fuel smell.", "Fuel cap warning."],
    ),
  ...
  pcv: {
    ...
    inspection: TL(
      ["Karter ventilyatsiyasi tizimini tekshiring."],
      ["Проверка системы вентиляции картера."],
      ["Inspect the crankcase ventilation system."],
    ),
    replacement: TL(
      ["Tiqilgan bo'lsa tozalang yoki komponentlarni almashtiring."],
      ["При засорении — очистка или замена компонентов."],
      ["Clean or replace components if blocked."],
    ),
    heavyUsage: TL(
      ["Eski moy va qisqa safarlar PCV ifloslanishini tezlashtiradi."],
      ["Старое масло и короткие поездки засоряют PCV быстрее."],
      ["Old oil and short trips clog the PCV faster."],
    ),
    warnings: TL(
      ["Salt yurish beqaror.", "Moy iste'molining oshishi.", "Tiqilish belgilari."],
      ["Неустойчивый холостой ход.", "Рост расхода масла.", "Признаки засорения."],
      ["Unstable idle.", "Increased oil consumption.", "Signs of blockage."],
    ),
  ...
  seatBelts: {
    partId: "seatBelts",
    title: T(
      "Xavfsizlik kamarlari va qulflari",
    ...
    inspection: TL(
      ["Har servisda tekshiring.", "Lenta va qulflarning ishlashini sinab ko'ring."],
      ["Проверка на каждом ТО.", "Тестирование ленты и замков."],
      ["Inspect every service.", "Test webbing and locks function."],
    ),
    replacement: TL(
      ["Shikastlangan, kesilgan yoki noto'g'ri ishlayotgan kamarlarni almashtiring."],
      ["Меняйте повреждённые, рваные или неисправные ремни."],
      ["Replace damaged, cut or malfunctioning belts."],
    ),
    heavyUsage: TL(
      ["Quyosh va eskirish lentaga ta'sir qiladi."],
      ["Солнце и износ влияют на ленту."],
      ["Sun and wear affect the webbing."],
    ),
    warnings: TL(
      ["Kamar tortilmaydi.", "Qulf yopilmaydi.", "Lenta yirtilgan."],
      ["Ремень не втягивается.", "Замок не защёлкивается.", "Лента порвана."],
      ["Belt does not retract.", "Lock does not engage.", "Webbing torn."],
    ),
    summaryInspection: T("Har servisda.", "На каждом ТО.", "Every service."),
    summaryReplacement: T(
      "Shikastlanganda darhol.",
      "При повреждении — сразу.",
      "On damage — immediately.",
    ),
    badges: ["inspect", "safety"],
  },
};
