...
const MODELS_WITH_FULL_PART_IMAGERY = new Set(["gentra-15l", "gentra", "tracker", "trailblazer", "tahoe", "traverse", "equinox", "malibu", "m5", "x5", "7-series-sedan", "i7", "c-class", "e-class"]);
