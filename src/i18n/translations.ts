...
export const translations: Record<Lang, Dict> = {
  uz: {
    ...
    "model.parts": "Qismlar",
    "model.tab.overview": "Umumiy",
    "model.tab.technical": "Texnik",
    "model.tab.service": "Servis",
    "model.facts.title": "Asosiy ma'lumotlar",
    "model.facts.bodyType": "Transport turi",
    "model.facts.tirePressure": "Shina bosimi (old/orqa)",
    "model.facts.tireLife": "Shina resursi",
    "model.facts.partsTracked": "Kuzatiladigan qismlar",
    "model.facts.explorePartsCta": "Barcha qismlarni ko'rish",
  ...
  ru: {
    ...
    "model.parts": "Части",
    "model.tab.overview": "Общее",
    "model.tab.technical": "Технические",
    "model.tab.service": "Сервис",
    "model.facts.title": "Основные данные",
    "model.facts.bodyType": "Тип кузова",
    "model.facts.tirePressure": "Давление шин (перед/зад)",
    "model.facts.tireLife": "Ресурс шин",
    "model.facts.partsTracked": "Отслеживаемые части",
    "model.facts.explorePartsCta": "Смотреть все части",
  ...
  en: {
    ...
    "model.parts": "Parts",
    "model.tab.overview": "Overview",
    "model.tab.technical": "Technical",
    "model.tab.service": "Service",
    "model.facts.title": "Key facts",
    "model.facts.bodyType": "Body type",
    "model.facts.tirePressure": "Tire pressure (F/R)",
    "model.facts.tireLife": "Tire lifespan",
    "model.facts.partsTracked": "Parts tracked",
    "model.facts.explorePartsCta": "Explore all parts",
